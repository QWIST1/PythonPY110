...
def current_weather(lat, lon):
    ...
    """
    token = '93789642-2750-49eb-bef1-c576e4ee0b5f'  # Вставить ваш токен
    ...
    result = {
        ...
        'feels_like_temp': data['fact']['feels_like'],  # TODO Реализовать вычисление ощущаемой температуры
        ...
        'wind_speed': data['fact']['wind_speed'],  # TODO Реализовать вычисление скорости ветра
        'wind_gust': data['fact']['wind_gust'],  # TODO Реализовать вычисление скорости порывов
